...
begin
    ...
    and l.id_lugar_lugar = l2.id_lugar and l2.id_lugar_lugar = l3.id_lugar and l.id_lugar = id_p and p.status_persona = 'Infectado';
    ...
    if(poblacionI < nivel1) then
        ...
        dbms_output.put_line('LIBRE MOVILIDAD HASTA EL PROXIMO CHEQUEO EL ' ||aislamientoF);
        
    elsif(poblacionI >= nivel1) then
